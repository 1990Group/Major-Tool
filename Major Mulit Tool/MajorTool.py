# Copyright (c) Major T00l2s  (discord.gg/YRT6SZ8Z)
...
option_01_txt = f"{red}[{red}01{red}]{white} " + option_01.ljust(30)[:30].replace("-", " ")
option_02_txt = f"{red}[{white}02{red}]{white} " + option_02.ljust(30)[:30].replace("-", " ")
option_03_txt = f"{red}[{red}03{red}]{white} " + option_03.ljust(30)[:30].replace("-", " ")
option_04_txt = f"{red}[{white}04{red}]{white} " + option_04.ljust(30)[:30].replace("-", " ")
option_05_txt = f"{red}[{red}05{red}]{white} " + option_05.ljust(30)[:30].replace("-", " ")
option_06_txt = f"{red}[{white}06{red}]{white} " + option_06.ljust(30)[:30].replace("-", " ")
option_07_txt = f"{red}[{red}07{red}]{white} " + option_07.ljust(30)[:30].replace("-", " ")
option_08_txt = f"{red}[{white}08{red}]{white} " + option_08.ljust(30)[:30].replace("-", " ")
option_09_txt = f"{red}[{red}09{red}]{white} " + option_09.ljust(30)[:30].replace("-", " ")
...
option_12_txt = f"{red}[{red}12{red}]{white} " + option_12.ljust(30)[:30].replace("-", " ")
option_13_txt = f"{red}[{white}13{red}]{white} " + option_13.ljust(30)[:30].replace("-", " ")
option_14_txt = f"{red}[{red}14{red}]{white} " + option_14.ljust(30)[:30].replace("-", " ")
option_15_txt = f"{red}[{white}15{red}]{white} " + option_15.ljust(30)[:30].replace("-", " ")
option_16_txt = f"{red}[{red}16{red}]{white} " + option_16.ljust(30)[:30].replace("-", " ")
option_17_txt = f"{red}[{white}17{red}]{white} " + option_17.ljust(30)[:30].replace("-", " ")
option_18_txt = f"{red}[{red}18{red}]{white} " + option_18.ljust(30)[:30].replace("-", " ")
option_19_txt = f"{red}[{white}19{red}]{white} " + option_19.ljust(30)[:30].replace("-", " ")
option_20_txt = f"{red}[{red}20{red}]{white} " + option_20.ljust(30)[:30].replace("-", " ")

option_21_txt = f"{red}[{white}21{red}]{white} " + option_21.ljust(30)[:30].replace("-", " ")
option_22_txt = f"{red}[{red}22{red}]{white} " + option_22.ljust(30)[:30].replace("-", " ")
option_23_txt = f"{red}[{white}23{red}]{white} " + option_23.ljust(30)[:30].replace("-", " ")
option_24_txt = f"{red}[{red}24{red}]{white} " + option_24.ljust(30)[:30].replace("-", " ")
option_25_txt = f"{red}[{white}25{red}]{white} " + option_25.ljust(30)[:30].replace("-", " ")
option_26_txt = f"{red}[{red}26{red}]{white} " + option_26.ljust(30)[:30].replace("-", " ")
option_27_txt = f"{red}[{white}27{red}]{white} " + option_27.ljust(30)[:30].replace("-", " ")
option_28_txt = f"{red}[{red}28{red}]{white} " + option_28.ljust(30)[:30].replace("-", " ")
option_29_txt = f"{red}[{white}29{red}]{white} " + option_29.ljust(30)[:30].replace("-", " ")
option_30_txt = f"{red}[{red}30{red}]{white} " + option_30.ljust(30)[:30].replace("-", " ")

option_31_txt = f"{red}[{white}31{red}]{white} " + option_31.ljust(30)[:30].replace("-", " ")
option_32_txt = f"{red}[{red}32{red}]{white} " + option_32.ljust(30)[:30].replace("-", " ")
option_33_txt = f"{red}[{white}33{red}]{white} " + option_33.ljust(30)[:30].replace("-", " ")
option_34_txt = f"{red}[{red}34{red}]{white} " + option_34.ljust(30)[:30].replace("-", " ")
option_35_txt = f"{red}[{white}35{red}]{white} " + option_35.ljust(30)[:30].replace("-", " ")
option_36_txt = f"{red}[{red}36{red}]{white} " + option_36.ljust(30)[:30].replace("-", " ")
option_37_txt = f"{red}[{white}37{red}]{white} " + option_37.ljust(30)[:30].replace("-", " ")
option_38_txt = f"{red}[{red}38{red}]{white} " + option_38.ljust(30)[:30].replace("-", " ")
option_39_txt = f"{red}[{white}39{red}]{white} " + option_39.ljust(30)[:30].replace("-", " ")
option_40_txt = f"{red}[{red}40{red}]{white} " + option_40.ljust(30)[:30].replace("-", " ")

option_41_txt = f"{red}[{white}41{red}]{white} " + option_41.ljust(30)[:30].replace("-", " ")
option_42_txt = f"{red}[{red}42{red}]{white} " + option_42.ljust(30)[:30].replace("-", " ")
option_43_txt = f"{red}[{white}43{red}]{white} " + option_43.ljust(30)[:30].replace("-", " ")
option_44_txt = f"{red}[{red}44{red}]{white} " + option_44.ljust(30)[:30].replace("-", " ")
option_45_txt = f"{red}[{white}45{red}]{white} " + option_45.ljust(30)[:30].replace("-", " ")
option_46_txt = f"{red}[{red}46{red}]{white} " + option_46.ljust(30)[:30].replace("-", " ")
option_47_txt = f"{red}[{white}47{red}]{white} " + option_47.ljust(30)[:30].replace("-", " ")
option_48_txt = f"{red}[{red}48{red}]{white} " + option_48.ljust(30)[:30].replace("-", " ")
option_49_txt = f"{red}[{white}49{red}]{white} " + option_49.ljust(30)[:30].replace("-", " ")
option_50_txt = f"{red}[{red}50{red}]{white} " + option_50.ljust(30)[:30].replace("-", " ")

option_51_txt = f"{red}[{white}51{red}]{white} " + option_51.ljust(30)[:30].replace("-", " ")
option_52_txt = f"{red}[{red}52{red}]{white} " + option_52.ljust(30)[:30].replace("-", " ")
option_53_txt = f"{red}[{white}53{red}]{white} " + option_53.ljust(30)[:30].replace("-", " ")
option_54_txt = f"{red}[{red}54{red}]{white} " + option_54.ljust(30)[:30].replace("-", " ")
option_55_txt = f"{red}[{white}55{red}]{white} " + option_55.ljust(30)[:30].replace("-", " ")
option_56_txt = f"{red}[{red}56{red}]{white} " + option_56.ljust(30)[:30].replace("-", " ")
option_57_txt = f"{red}[{white}57{red}]{white} " + option_57.ljust(30)[:30].replace("-", " ")
option_58_txt = f"{red}[{red}58{red}]{white} " + option_58.ljust(30)[:30].replace("-", " ")
option_59_txt = f"{red}[{white}59{red}]{white} " + option_59.ljust(30)[:30].replace("-", " ")
option_60_txt = f"{red}[{red}60{red}]{white} " + option_60.ljust(30)[:30].replace("-", " ")

option_61_txt = f"{red}[{white}61{red}]{white} " + option_61.ljust(30)[:30].replace("-", " ")
option_62_txt = f"{red}[{red}62{red}]{white} " + option_62.ljust(30)[:30].replace("-", " ")
option_63_txt = f"{red}[{white}63{red}]{white} " + option_63.ljust(30)[:30].replace("-", " ")
option_64_txt = f"{red}[{red}64{red}]{white} " + option_64.ljust(30)[:30].replace("-", " ")
option_65_txt = f"{red}[{white}65{red}]{white} " + option_65.ljust(30)[:30].replace("-", " ")
option_66_txt = f"{red}[{red}66{red}]{white} " + option_66.ljust(30)[:30].replace("-", " ")
option_67_txt = f"{red}[{white}67{red}]{white} " + option_67.ljust(30)[:30].replace("-", " ")
option_68_txt = f"{red}[{red}68{red}]{white} " + option_68.ljust(30)[:30].replace("-", " ")
option_69_txt = f"{red}[{white}69{red}]{white} " + option_69.ljust(30)[:30].replace("-", " ")
option_70_txt = f"{red}[{red}70{red}]{white} " + option_70.ljust(30)[:30].replace("-", " ")

option_71_txt = f"{red}[{white}71{red}]{white} " + option_71.ljust(30)[:30].replace("-", " ")
option_72_txt = f"{red}[{red}72{red}]{white} " + option_72.ljust(30)[:30].replace("-", " ")
option_73_txt = f"{red}[{white}73{red}]{white} " + option_73.ljust(30)[:30].replace("-", " ")
option_74_txt = f"{red}[{red}74{red}]{white} " + option_74.ljust(30)[:30].replace("-", " ")
option_75_txt = f"{red}[{white}75{red}]{white} " + option_75.ljust(30)[:30].replace("-", " ")
option_76_txt = f"{red}[{red}76{red}]{white} " + option_76.ljust(30)[:30].replace("-", " ")
option_77_txt = f"{red}[{white}77{red}]{white} " + option_77.ljust(30)[:30].replace("-", " ")
option_78_txt = f"{red}[{red}78{red}]{white} " + option_78.ljust(30)[:30].replace("-", " ")
...
while True:
   try:
      ...
      choice = input(MainColor(f""" ┌──({white}{username_pc}@/MajorTool)─{red}[{white}~/Major/Menu-{menu_number}]
 └─{white}$ {reset}"""))
