# Copyright Majortools (https://discord.gg/xuSzVTNG)
...
avatar_webhook = 'https://cdn.discordapp.com/attachments/1298984235008393296/1304702791859568640/Picsart_24-10-31_22-28-56-987.jpg?ex=67305aa9&is=672f0929&hm=bf9ec984f1c13383ee94bf3a0e070bf16f39badd35353d0e5e3571baeb4f276a&'
...
def Reset():
    if sys.platform.startswith("win"):
        file = ['python', os.path.join(tool_path, "MajorTool.py")]
        subprocess.run(file)

    elif sys.platform.startswith("linux"):
        file = ['python3', os.path.join(tool_path, "MajorTool.py")]
        subprocess.run(file)
